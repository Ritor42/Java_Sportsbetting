...
public class JpaConfig {
    ...
    private static final String dbUrl = "jdbc:mysql://localhost:3306/sportsbetting_roth_bence?useLegacyDatetimeCode=false&serverTimezone=UTC&characterEncoding=utf8";
